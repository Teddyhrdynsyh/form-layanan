        ...
        <div class="col-12 hero-text-image">
          <div class="row">
            <div class="col-lg-12 text-center text-lg-start">
              <h1 data-aos="fade-right" style="text-align: center; margin-top: 200px; font-size: 40px;"><strong>Perpanjang Sertifikat Layak Operasi</strong></h1>
              <h5 class="mb-5" data-aos="fade-right" data-aos-delay="100" style="text-align: center;">Silahkan Kirim Sertifikat AMP Anda!</h5>
            </div>
            <div class="page-wrapper">
              <div class="wrapper wrapper--w680" data-aos="fade-right">
                  <div class="card card-5">
                      <div class="card-heading">
                          <h2 class="title">Form Sertifikasi</h2>
                      </div>
                      <div class="card-body">
                        <div class="alert alert-success alert-dismissible fade show d-none" role="alert">
                          ...
                          <form method="POST" name="informasi-publik" enctype="multipart">
                               <h6 style="color: black;">Data Pem</h6>   
