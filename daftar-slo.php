  ...
  <div class="sewa"> 
    <div class="card card-5" data-aos="fade-right" data-aos-delay="200" >
        ...
        <div class="card-body">
            ...
            <form id="uploadForm" method="POST" action="https://script.google.com/macros/s/AKfycbwJNMqp23APqwaGFpEqGJpaRY1CFSF10S7YDSYAfVidMr3oUMU8qbEm_EMow0KChhnNaw/exec" enctype="multipart">
                ...
                <div class="mb-3 ">
                    <label for="file" class="form-label">Upload Izin Lingkungan</label>
