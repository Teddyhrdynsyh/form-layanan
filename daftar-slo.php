    ...
    <div class="card card-5" data-aos="fade-right" data-aos-delay="200" >
        ...
        <div class="card-body">
            ...
            <form id="uploadForm" method="POST" enctype="multipart/form-data" onsubmit="return validateForm();">
                ...
                <div class="mb-3 ">
                    <label for="file" class="form-label">Upload Surat Izin Lingkungan</label>
...
<script>
  document.addEventListener('DOMContentLoaded', function() {
    document.getElementById('uploadForm').addEventListener('submit', function(e) {
      ...
      reader.onload = function() {
        ...
        fetch('https://script.google.com/macros/s/AKfycbwJNMqp23APqwaGFpEqGJpaRY1CFSF10S7YDSYAfVidMr3oUMU8qbEm_EMow0KChhnNaw/exec', {
            method: 'POST',
            body: formData
          })
          .then(response => {
  ...
  function validateForm() {
    ...
    if (attach == "") {
        alert("Surat Izin Lingkungan harus diupload");
